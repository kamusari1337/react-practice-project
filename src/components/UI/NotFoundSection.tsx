			...
			<Link to={'/'} className={styles.section__button}>
				<svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g clip-path="url(#clip0_607_199)">
						<path d="M14.7143 7H1" stroke="#EEF2F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
						<path d="M7 13L1 7L7 1" stroke="#EEF2F9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
					</g>
					<defs>
