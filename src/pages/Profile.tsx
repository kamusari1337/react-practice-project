	...
	return (
		<>
			...
			<div className={styles.section}>
				...
				<div className={styles.section__list}>{purchasesAmount > 0 ? purchases.map(manga => <Card key={manga.id} {...manga}></Card>) : <NotFoundSection message1="У вас нет заказов" message2="Оформите хотя бы один заказ..." face={<SadFace />} />}</div>
			</div>
		</>
	)
}
